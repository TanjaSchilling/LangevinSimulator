...
data=readBinary("../TEST_OUT_2/traj.f64")
plt.plot(times,data[0,:,0],color="green",label="mollified trajectory")
data = readBinary("traj.f64")
plt.plot(times,data[0,:,0],color="blue",label="simulated trajectory")
plt.legend()
plt.savefig("trajectories.png")
plt.show()

data=readBinary("../TEST_OUT_2/correlation.f64")
plt.plot(times,data[500,0,:,0],color="green",label="correlation function of mollified trajectories")
data = readBinary("correlation.f64")
plt.plot(times,data[500,0,:,0],color="blue",label="correlation function of simulations")
plt.legend()
plt.savefig("corr.png")
plt.show()


data=readBinary("../TEST_OUT_2/kernel.f64")
plt.plot(times,data[500,:,0,0],color="green",label="memory kernel of mollified trajectories")
data = readBinary("kernel.f64")
plt.plot(times,data[500,:,0,0],color="blue",label="memory kernel of simulations")
plt.legend()
