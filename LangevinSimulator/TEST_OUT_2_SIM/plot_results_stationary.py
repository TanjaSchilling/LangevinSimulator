...
data=readBinary("../TEST_OUT_2/correlation_stationary.f64")
...
plt.plot(data[:,0,0],color="blue",label="correlation function of simulations")
plt.legend()
plt.savefig("corr.png")
plt.show()


data=readBinary("../TEST_OUT_2/kernel_stationary.f64")
plt.plot(data[:,0,0],color="green",label="memory kernel of mollified trajectories")
data = readBinary("kernel_stationary.f64")
plt.plot(data[:,0,0],color="blue",label="memory kernel of simulations")
plt.legend()
