...
General instructions on the usage of LangevinSimulator are given on this mainpage.
For further reading, please see the namespaces InputOutput and KernelMethods as well as the classes RandomForceGenerator and RK4.
