...
namespace InputOutput
{
    ...
    vector<string> getDataFilenames(
        string file_range,
        string in_folder,
        string in_prefix)
    {
    ...
    tensor<double,3> readTrajectories(
    ...
    tensor<double,1> popTimes(tensor<double,3> &trajectories)
    {
    ...
    void write(tensor<double,1> &times, tensor<double,4> &corr, string path)
    {
        ofstream out;
        out << scientific;
        out << setprecision(15);
    ...
    void write(tensor<double,1> &times, tensor<double,3> &corr, string path)
    {
        ofstream out;
        out << scientific;
        out << setprecision(15);
