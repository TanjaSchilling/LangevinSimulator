...
plt.plot(times,data[200,0,:,0],label="correlation function, observable 0x0")
plt.legend()
plt.savefig("corr00.png")
plt.show()

data = readBinary("correlation.f64")
plt.plot(times,data[200,1,:,1],label="correlation function, observable 1x1")
plt.legend()
plt.savefig("corr11.png")
plt.show()


plt.plot(times,data[200,1,:,0],label="correlation function, observable 1x0")
plt.legend()
plt.savefig("corr10.png")
plt.show()


plt.plot(times,data[200,0,:,1],label="correlation function, observable 0x1")
plt.legend()
plt.savefig("corr01.png")
plt.show()

data=readBinary("kernel.f64")
plt.plot(times,data[200,:,0,0],label="memory kernel, observable 0x0")
plt.legend()
plt.savefig("kernel00.png")
plt.show()

plt.plot(times,data[200,:,1,1],label="memory kernel, observable 1x1")
plt.legend()
plt.savefig("kernel11.png")
plt.show()

plt.plot(times,data[200,:,1,0],label="memory kernel, observable 1x0")
plt.legend()
plt.savefig("kernel10.png")
plt.show()

plt.plot(times,data[200,:,0,1],label="memory kernel, observable 0x1")
plt.legend()
